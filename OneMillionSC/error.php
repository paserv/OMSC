<div id="error">
	...
	if($excep->error_code){
		...
		$controller->sendEmail("Administrator OMSC", "administrator@omsc.com", " Public Message: " . $publicMessage . " - Private Message: " . $excep->private_message . " - Timestamp: " . date('YmdHis'));
		$controller->logError("Timestamp: " . date('YmdHis') . " Public Message: " . $publicMessage . " - Private Message: " . $excep->private_message);
	} else {
		$controller->sendEmail("Administrator OMSC", "administrator@omsc.com", " Public Message: " . $publicMessage . " - Private Message: EMPTY - Timestamp: " . date('YmdHis'));
		$controller->logError("Timestamp: " . date('YmdHis') . " Public Message: " . $publicMessage . " - Private Message: EMPTY");
		echo '<div class="container">
					<div class="row">
						<div class="col s12"><h5>Error<i class="material-icons left small">error</i></h5></div>
					</div>
